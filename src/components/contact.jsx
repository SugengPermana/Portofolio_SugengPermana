  ...
  return (
    <section id="contact" className="mt-24 px-5 bg-zinc-900">
      ...
      <div className="mt-16">
        ...
        Looking for a reliable freelancer? I’m here to help you design, build, and launch your next big thing.
      </p>
      </div>

      <div className="max-w-screen-lg mx-auto grid lg:grid-cols-2 gap-8 lg:gap-12">
        ...
        <div className="flex flex-col justify-start h-full">
          ...
          <p className="text-zinc-400 text-sm sm:text-base md:text-lg leading-relaxed mb-8 flex-grow">
            I’m always excited about new projects and opportunities. From modern web apps to smart workflow automation, I help businesses save time and scale faster.
            Ready to bring your ideas to the next level? I’m just one message away.
          </p>
...
<div className="w-full h-[250px] sm:h-[300px] rounded-xl overflow-hidden shadow-lg">
  ...
  ></iframe>
        ...
        <div className="bg-zinc-800/60 p-4 lg:p-6 rounded-xl shadow-md flex flex-col h-full">
          <form action="https://formsubmit.co/sugengpermanadesembry@gmail.com" method="POST" className="flex flex-col gap-3 lg:gap-4 h-full">
            <input
              type="text"
              placeholder="Your Name"
              className="p-2 lg:p-3 rounded-md bg-zinc-900 text-white text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-violet-600 border border-zinc-700" required
            />
            <input
              type="email"
            ...
            <textarea
              ...
              rows="3"
              className="p-2 lg:p-3 rounded-md bg-zinc-900 text-white text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-violet-600 border border-zinc-700 resize-none flex-1" required
            ></textarea>
