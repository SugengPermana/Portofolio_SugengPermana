...
const Preloader = () => {
  const fullText = "Sugeng Permana Desembry";
  ...
  useEffect(() => {
    let index = 0;
    let deleting = false;
    const typingSpeed = 80;   // kecepatan ketik
  ...
  return (
    <div
      className={`fixed inset-0 flex flex-col items-center justify-center bg-black z-50 transition-opacity duration-300 ${
