...
<div className="work-experience mt-32 px-5" id="experience">
  <div className="max-w-screen-lg mx-auto">
    {/* Section Title */}
    <div className="text-center mb-14">
      <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white" data-aos="fade-up"
      data-aos-duration="1000"
      data-aos-once="true">
    ...
    <div className="relative">
      ...
      {/* Card 1 (Kiri) */}
      <div className="relative mb-10 md:mb-16 flex flex-col md:flex-row md:justify-start"
      data-aos="fade-right"
      data-aos-duration="2000">
        {/* Bulatan */}
  ...
  <div className="flex flex-col min-w-0">
    ...
    <a href="#" className="text-violet-500 text-xs sm:text-sm flex items-center gap-1 hover:underline truncate">
  ...
  <span className="border border-violet-500 text-violet-500 px-2 sm:px-3 py-1 rounded-full whitespace-nowrap text-xs sm:text-sm flex-shrink-0 ml-auto sm:ml-4 md:ml-auto">
    PT
            ...
            <p className="text-zinc-300 mt-2 text-sm sm:text-base">
              Developing and maintaining web applications as a freelance developer.
              Responsible for full-stack development, UI/UX design, and performance optimization.
            </p>
            ...
            <div className="flex flex-wrap gap-2">
              <span className="bg-violet-600 text-white px-3 py-1 rounded-full text-xs sm:text-sm">Laravel</span>
              <span className="bg-violet-600 text-white px-3 py-1 rounded-full text-xs sm:text-sm">PHP</span>
              <span className="bg-violet-600 text-white px-3 py-1 rounded-full text-xs sm:text-sm">Tailwind CSS</span>
              <span className="bg-violet-600 text-white px-3 py-1 rounded-full text-xs sm:text-sm">React</span>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Card 2 (Kanan) */}
      <div className="relative mb-10 md:mb-16 flex flex-col md:flex-row md:justify-end"
      data-aos="fade-left"
      data-aos-duration="2000">
        {/* Bulatan */}
        <div className="absolute top-6 left-4 md:left-1/2 md:-translate-x-1/2 w-4 h-4 bg-violet-500 rounded-full border-2 border-zinc-900"></div>
        ...
        <div className="md:w-1/2 md:pl-8 ml-12 md:ml-0">
          <div className="group bg-zinc-800 border border-zinc-700 rounded-xl p-4 sm:p-6 md:p-8 transition duration-300 hover:border-violet-500 hover:shadow-lg hover:shadow-violet-500/20">
            ...
            <p className="text-zinc-300 mt-2 text-sm sm:text-base">
              Working on GCP projects, deploying services with Cloud Run, BigQuery, and Terraform.
            </p>
          </div>
        </div>
      </div>
